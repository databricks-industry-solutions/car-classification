...
job_json = {
        ...
        "tasks": [
            {
                "job_cluster_key": "car_cluster",
                "libraries": [],
                "notebook_task": {
                    "notebook_path": f"00_car_context" # different from standard API
                },
                "task_key": "car_00",
                "description": ""
            },
            {
                ...
                "libraries": [],
                "notebook_task": {
                    "notebook_path": f"01_car_etl" # different from standard API
                },
                "task_key": "car_01",
                "depends_on": [
                    {
            ...
            },
            {
                "job_cluster_key": "car_cluster",
                "notebook_task": {
                    "notebook_path": f"02_car_ml" # different from standard API
                },
                "task_key": "car_02",
                "depends_on": [
                    {
